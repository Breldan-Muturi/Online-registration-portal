...
import { toggleModalRejectSelectedPayments } from "../../Features/lists/paymentListSlice";

const RejectSelectedPayments = () => {
  const dispatch = useDispatch();
  const { selectedPayments, modalRejectSelectedPayments } = useSelector(
  ...
  const handleDelete = async () => {
    ...
    isSuccess && dispatch(toggleModalRejectSelectedPayments());
  };
  ...
  return (
    <>
      <Button
        ...
        size="small"
        color="error"
        onClick={() => dispatch(toggleModalRejectSelectedPayments())}
      >
        Delete
      </Button>
      <Dialog
        open={modalRejectSelectedPayments}
        onClose={() => dispatch(toggleModalRejectSelectedPayments())}
...
export default RejectSelectedPayments;
